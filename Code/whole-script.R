...
ggsave("plot_1_gravida.pdf", height = 6, width = 8, dpi = 300)
...
pca_data <- full_data_wide[,33:710]
...
############################################################################
# Logistic regression using PCA outout
data_transformed <- predict(res.pca, newdata = pca_data)[,1:5]
...
var2csa_plot <- ggboxplot(VAR2CSA, 
 ...
 ###############################################################################
# Assesing logistic regression using the volcano data 
